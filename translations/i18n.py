...
TRANSLATIONS = {
    ...
    "settings_desc_custom_force": {
        "en": f'    ┗ {_e("5316571734604790521", "⚡")} Force Register',
        "ru": f'    ┗ {_e("5316571734604790521", "⚡")} Принудительная регистрация',
        "ar": f'    ┗ {_e("5316571734604790521", "⚡")} التسجيل الإجباري',
